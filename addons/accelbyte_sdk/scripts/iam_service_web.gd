...
func _http_request(url: String, method: int, headers: PackedStringArray, body: String = "") -> Dictionary:
	print("  [IamServiceWeb] %s %s" % [_method_to_string(method), url])
	...
	print("  [IamServiceWeb] Response: %d - %s" % [response_code, "success" if result["success"] else "failed"])
	return result
...
## @deprecated
func delete_client(client_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_client(client_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func update_client(client_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func update_client_permission(client_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func delete_client_permission(action: int,client_id: String,resource: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "action" + "}", _url_encode(str(action)))
	url_path = url_path.replace("{" + "clientId" + "}", _url_encode(client_id))
	url_path = url_path.replace("{" + "resource" + "}", _url_encode(resource))
...
## @deprecated
func add_client_permission(action: int,client_id: String,resource: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func update_client_secret(client_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_clientsby_namespace(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func create_client_by_namespace(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func delete_client_by_namespace(client_id: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func create_user(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_admin_users_by_role_id(namespace_param: String,after: int = 0,before: int = 0,limit: int = 0,role_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_user_by_login_id(namespace_param: String,login_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_user_by_platform_user_id(namespace_param: String,platform_id: String,platform_user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func forgot_password(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_users_by_login_ids(namespace_param: String,login_ids: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func reset_password(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func search_user(namespace_param: String,query: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func delete_user(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_user_by_user_id(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func update_user(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func ban_user(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_user_ban_history(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func disable_user_ban(ban_id: String,namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "banId" + "}", _url_encode(ban_id))
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	url_path = url_path.replace("{" + "userId" + "}", _url_encode(user_id))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
...
## @deprecated
func enable_user_ban(ban_id: String,namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func list_cross_namespace_account_link(linking_token: String,namespace_param: String,user_id: String,platform_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func disable_user(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func enable_user(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func delete_user_information(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_user_information(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_user_login_histories(namespace_param: String,user_id: String,after: float = 0.0,before: float = 0.0,limit: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func update_password(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func save_user_permission(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func delete_user_permission(action: int,namespace_param: String,resource: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func add_user_permission(action: int,namespace_param: String,resource: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_user_platform_accounts(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_user_mapping(namespace_param: String,target_namespace: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	url_path = url_path.replace("{" + "targetNamespace" + "}", _url_encode(target_namespace))
	url_path = url_path.replace("{" + "userId" + "}", _url_encode(user_id))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
## @deprecated
func get_user_justice_platform_account(namespace_param: String,target_namespace: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func platform_link(ticket: String,namespace_param: String,platform_id: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func platform_unlink(namespace_param: String,platform_id: String,user_id: String,platform_namespace: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_publisher_user(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func save_user_roles(namespace_param: String,user_id: String,
		body: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func delete_user_role(namespace_param: String,role_id: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	url_path = url_path.replace("{" + "roleId" + "}", _url_encode(role_id))
	url_path = url_path.replace("{" + "userId" + "}", _url_encode(user_id))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
## @deprecated
func add_user_role(namespace_param: String,role_id: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func upgrade_headless_account(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func upgrade_headless_account_with_verification_code(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func user_verification(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func send_verification_code(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func authorization(client_id: String,redirect_uri: String,response_type: String,login: String = "",password: String = "",scope: String = "",state: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func platform_token_request_handler(namespace_param: String,platform_id: String,device_id: String = "",mac_address: String = "",platform_token: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func revoke_user(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func revoke_token(token: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func revoke_auser(user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func token_grant(grant_type: String,code: String = "",extend_exp: bool = false,namespace_param: String = "",password: String = "",redirect_uri: String = "",refresh_token: String = "",username: String = "",device_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func verify_token(token: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	# Basic Auth: always from SDK settings (no client_id/client_secret form params)
	var _client_id: String = _sdk.get_client_id() if _sdk else ""
	var _client_secret: String = _sdk.get_client_secret() if _sdk else ""
	var auth_string: String = _client_id + ":" + _client_secret
	var base64_auth: String = Marshalls.raw_to_base64(auth_string.to_utf8_buffer())
...
## GET /iam/roles
## @deprecated
func get_roles(is_wildcard: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func delete_role(role_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func update_role(role_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func remove_role_admin(role_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_role_admin_status(role_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func set_role_as_admin(role_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func remove_role_managers(role_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_role_managers(role_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func add_role_managers(role_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func remove_role_members(role_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_role_members(role_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func add_role_members(role_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func update_role_permissions(role_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func delete_role_permission(action: int,resource: String,role_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func add_role_permission(action: int,resource: String,role_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func admin_get_age_restriction_status_v2(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func admin_update_age_restriction_config_v2(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_list_country_age_restriction(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func update_country_age_restriction(country_code: String,namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func admin_search_users_v2(namespace_param: String,platform_id: String,after: String = "",before: String = "",display_name: String = "",limit: int = 0,login_id: String = "",platform_user_id: String = "",role_id: String = "",user_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func admin_get_user_by_user_id_v2(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func admin_update_user_v2(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func admin_ban_user_v2(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func admin_get_user_ban_v2(namespace_param: String,user_id: String,active_only: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func admin_disable_user_v2(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func admin_enable_user_v2(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func admin_reset_password_v2(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func admin_delete_platform_link_v2(namespace_param: String,platform_id: String,user_id: String,platform_namespace: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func admin_create_user_roles_v2(namespace_param: String,user_id: String,
		body: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func admin_put_user_roles_v2(namespace_param: String,user_id: String,
		body: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_get_country_age_restriction(country_code: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_create_user_v2(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_forgot_password_v2(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_reset_password_v2(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_get_user_by_user_idv2(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_update_user_v2(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_get_user_ban(namespace_param: String,user_id: String,active_only: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_update_password_v2(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_list_justice_platform_accounts(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_delete_platform_link_v2(namespace_param: String,platform_id: String,user_id: String,platform_namespace: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_platform_link_v2(ticket: String,namespace_param: String,platform_id: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_delete_config_permissions_by_group(force_delete: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_list_client_available_permissions(exclude_permissions: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_available_permissions_by_module(force_delete: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## Set permission module package info
## PATCH /iam/v3/admin/clientConfig/permissions/package
func admin_update_module_package(
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	# Build URL path
	var url_path: String = "/iam/v3/admin/clientConfig/permissions/package"
...
## @deprecated
func admin_reset_input_validations(field: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "field" + "}", _url_encode(field))
...
func list_admins_v3(namespace_param: String,after: String = "",before: String = "",end_date: String = "",limit: int = 0,query: String = "",role_id: String = "",start_date: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_age_restriction_status_v3(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_age_restriction_config_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_list_country_age_restriction_v3(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_country_age_restriction_v3(country_code: String,namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_banned_users_v3(namespace_param: String,active_only: bool = false,ban_type: String = "",limit: int = 0,offset: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_ban_user_bulk_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_unban_user_bulk_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_bans_type_with_namespace_v3(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_clients_by_namespace_v3(namespace_param: String,client_id: String = "",client_name: String = "",client_type: String = "",limit: int = 0,offset: int = 0,skip_login_queue: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_create_client_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_bulk_update_clients_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_delete_client_v3(client_id: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_clientsby_namespaceby_idv3(client_id: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_client_v3(client_id: String,namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_add_client_permissions_v3(client_id: String,namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_client_permission_v3(client_id: String,namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_delete_client_permission_v3(action: int,client_id: String,namespace_param: String,resource: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_config_value_v3(config_key: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_country_list_v3(namespace_param: String,filter_blacklist: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_country_blacklist_v3(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_add_country_blacklist_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## Admin Get Input Validations
## GET /iam/v3/admin/namespaces/{namespace}/inputValidations
func admin_get_namespace_scoped_input_validations(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()

	# Build URL path
	var url_path: String = "/iam/v3/admin/namespaces/{namespace}/inputValidations"
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
## Admin Update Input Validations
## PUT /iam/v3/admin/namespaces/{namespace}/inputValidations
func admin_update_namespace_scoped_input_validations(namespace_param: String,
		body: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## Admin Reset Input Validations
## DELETE /iam/v3/admin/namespaces/{namespace}/inputValidations/{field}
func admin_reset_namespace_scoped_input_validations(field: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()

	# Build URL path
	var url_path: String = "/iam/v3/admin/namespaces/{namespace}/inputValidations/{field}"
	url_path = url_path.replace("{" + "field" + "}", _url_encode(field))
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
...
func admin_get_login_allowlist_v3(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_login_allowlist_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func retrieve_all_third_party_login_platform_credential_v3(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func retrieve_all_active_third_party_login_platform_credential_v3(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func retrieve_all_ssologin_platform_credential_v3(namespace_param: String,limit: int = 0,offset: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_third_party_login_platform_credential_v3(namespace_param: String,platform_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func retrieve_third_party_login_platform_credential_v3(namespace_param: String,platform_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_third_party_login_platform_credential_v3(namespace_param: String,platform_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func add_third_party_login_platform_credential_v3(namespace_param: String,platform_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_third_party_login_platform_domain_v3(namespace_param: String,platform_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func partial_update_third_party_login_platform_domain_v3(namespace_param: String,platform_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_third_party_login_platform_domain_v3(namespace_param: String,platform_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_ssologin_platform_credential_v3(namespace_param: String,platform_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func retrieve_ssologin_platform_credential(namespace_param: String,platform_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_ssoplatform_credential(namespace_param: String,platform_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func add_ssologin_platform_credential(namespace_param: String,platform_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_list_user_idby_platform_user_ids_v3(namespace_param: String,platform_id: String,raw_pid: bool = false,raw_puid: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_user_by_platform_user_idv3(namespace_param: String,platform_id: String,platform_user_id: String,pid_type: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	url_path = url_path.replace("{" + "platformId" + "}", _url_encode(platform_id))
	url_path = url_path.replace("{" + "platformUserId" + "}", _url_encode(platform_user_id))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func admin_get_profile_update_strategy_v3(namespace_param: String,field: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_profile_update_strategy_v3(namespace_param: String,field: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_role_override_config_v3(namespace_param: String,identity: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_role_override_config_v3(namespace_param: String,identity: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_role_source_v3(namespace_param: String,identity: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_change_role_override_config_status_v3(namespace_param: String,identity: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_role_namespace_permission_v3(namespace_param: String,role_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_admin_users_by_role_id_v3(namespace_param: String,role_id: String,after: int = 0,before: int = 0,limit: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_query_tag_v3(namespace_param: String,limit: int = 0,offset: int = 0,tag_name: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_create_tag_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_delete_tag_v3(namespace_param: String,tag_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_tag_v3(namespace_param: String,tag_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_user_by_email_address_v3(namespace_param: String,email_address: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_bulk_update_users_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_bulk_user_ban_v3(namespace_param: String,active_only: bool = false,ban_type: String = "",
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_bulk_get_users_platform(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_cursor_get_user_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_invite_user_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_query_third_platform_link_history_v3(namespace_param: String,platform_id: String,limit: int = 0,offset: int = 0,platform_user_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_list_users_v3(namespace_param: String,limit: int = 0,offset: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_search_user_v3(namespace_param: String,by: String = "",end_date: String = "",include_total: bool = false,limit: int = 0,offset: int = 0,platform_by: String = "",platform_id: String = "",query: String = "",role_ids: String = "",selected_fields: String = "",skip_login_queue: bool = false,start_date: String = "",tag_ids: String = "",test_account: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_bulk_user_by_email_address_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_user_by_user_id_v3(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_user_v3(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_user_ban_v3(namespace_param: String,user_id: String,active_only: bool = false,after: String = "",before: String = "",limit: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_ban_user_v3(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_user_ban_summary_v3(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_user_ban_v3(ban_id: String,namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_send_verification_code_v3(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_verify_account_v3(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_user_verification_code(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_user_deletion_status_v3(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_user_deletion_status_v3(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_list_user_all_platform_accounts_distinct_v3(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_upgrade_headless_account_v3(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_delete_user_information_v3(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_user_login_histories_v3(namespace_param: String,user_id: String,after: float = 0.0,before: float = 0.0,limit: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_reset_password_v3(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_delete_user_permission_bulk_v3(namespace_param: String,user_id: String,
		body: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_add_user_permissions_v3(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_user_permission_v3(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_delete_user_permission_v3(action: int,namespace_param: String,resource: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_user_platform_accounts_v3(namespace_param: String,user_id: String,after: String = "",before: String = "",limit: int = 0,platform_id: String = "",target_namespace: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_list_all_distinct_platform_accounts_v3(namespace_param: String,user_id: String,status: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_list_justice_platform_accounts(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_user_mapping(namespace_param: String,target_namespace: String,user_id: String,create_if_not_found: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_create_justice_user(namespace_param: String,target_namespace: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_link_platform_account(namespace_param: String,user_id: String,skip_conflict: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_user_link_histories_v3(namespace_param: String,user_id: String,platform_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func admin_platform_unlink_v3(namespace_param: String,platform_id: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_platform_unlink_all_v3(namespace_param: String,platform_id: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_platform_link_v3(ticket: String,namespace_param: String,platform_id: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func admin_delete_user_linking_history_by_platform_idv3(namespace_param: String,platform_id: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_delete_user_linking_restriction_by_platform_idv3(namespace_param: String,platform_id: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_third_party_platform_token_link_status_v3(platform_token: String,namespace_param: String,platform_id: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_user_single_platform_account(namespace_param: String,platform_id: String,user_id: String,cross_namespace: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_delete_user_roles_v3(namespace_param: String,user_id: String,
		body: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_save_user_role_v3(namespace_param: String,user_id: String,
		body: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_delete_user_role_v3(namespace_param: String,role_id: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_add_user_role_v3(namespace_param: String,role_id: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_user_state_by_user_id_v3(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_user_status_v3(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_trustly_update_user_identity(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_verify_user_without_verification_code_v3(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_client_secret_v3(client_id: String,namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_check_third_party_login_platform_availability_v3(platform_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_roles_v3(after: String = "",before: String = "",is_wildcard: bool = false,limit: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_delete_role_v3(role_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_role_v3(role_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_role_v3(role_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_remove_role_admin_v3(role_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_role_admin_status_v3(role_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_admin_role_status_v3(role_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_remove_role_managers_v3(role_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_role_managers_v3(role_id: String,after: String = "",before: String = "",limit: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_add_role_managers_v3(role_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func admin_remove_role_members_v3(role_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_role_members_v3(role_id: String,after: String = "",before: String = "",limit: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_add_role_members_v3(role_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_delete_role_permissions_v3(role_id: String,
		body: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_add_role_permissions_v3(role_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_role_permissions_v3(role_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_delete_role_permission_v3(action: int,resource: String,role_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func user_authentication_v3(password: String,request_id: String,user_name: String,client_id: String = "",extend_exp: bool = false,redirect_uri: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	# Basic Auth: use form client_id if provided, otherwise global settings
	if not client_id.is_empty():
		var client_secret_val: String = _sdk.get_client_secret() if _sdk else ""

		var auth_string: String = client_id + ":" + client_secret_val
		var base64_auth: String = Marshalls.raw_to_base64(auth_string.to_utf8_buffer())
		headers.push_back("Authorization: Basic " + base64_auth)
	else:
		var _client_id: String = _sdk.get_client_id() if _sdk else ""
...
func authentication_with_platform_link_v3(client_id: String,linking_token: String,password: String,username: String,extend_exp: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func authenticate_and_link_forward_v3(client_id: String,linking_token: String,password: String,username: String,extend_exp: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func generate_token_by_new_headless_account_v3(linking_token: String,additional_data: String = "",extend_exp: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func request_one_time_linking_code_v3(platform_id: String,redirect_uri: String = "",state: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func validate_one_time_linking_code_v3(one_time_link_code: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func request_token_by_one_time_link_code_response_v3(client_id: String,one_time_link_code: String,additional_data: String = "",is_transient: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func request_token_exchange_code_v3(client_id: String,namespace_param: String,code_challenge: String = "",code_challenge_method: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_retrieve_user_third_party_platform_token_v3(namespace_param: String,platform_id: String,user_id: String,platform_user_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func revoke_user_v3(namespace_param: String,user_id: String,include_game_namespace: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	var headers: PackedStringArray = _get_bearer_headers()
	var _result: Dictionary = await _http_request(url, HTTPClient.METHOD_POST, headers, request_body)
	# Auto-handle token revocation: clear tokens in SDK
	if _result.get("success", false) and _sdk:
		_sdk.set_auth_tokens("", "", "", 0)
	return _result

## OAuth2 authorize API
## GET /iam/v3/oauth/authorize
func authorize_v3(client_id: String,response_type: String,blocked_platform_id: String = "",code_challenge: String = "",code_challenge_method: String = "",create_headless: bool = false,login_web_based: bool = false,nonce: String = "",one_time_link_code: String = "",redirect_uri: String = "",scope: String = "",state: String = "",target_auth_page: String = "",use_redirect_uri_as_login_url_when_locked: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func token_introspection_v3(token: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func send_mfaauthentication_code(client_id: String,factor: String,mfa_token: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func change2_famethod(factor: String,mfa_token: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func verify2_facode(code: String,factor: String,mfa_token: String,remember_device: bool
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func verify2_facode_forward(client_id: String,code: String,factor: String,mfa_token: String,default_factor: String = "",factors: String = "",remember_device: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func retrieve_user_third_party_platform_token_v3(namespace_param: String,platform_id: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func auth_code_request_v3(platform_id: String,request_id: String,client_id: String = "",redirect_uri: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func platform_token_grant_v3(platform_id: String,additional_data: String = "",client_id: String = "",create_headless: bool = false,device_id: String = "",mac_address: String = "",platform_token: String = "",service_label: float = 0.0,skip_set_cookie: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func token_revocation_v3(token: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func simultaneous_login_v3(native_platform: String,native_platform_ticket: String,simultaneous_platform: String = "",simultaneous_ticket: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func token_grant_v3(grant_type: String,additional_data: String = "",client_id: String = "",client_secret: String = "",code: String = "",code_verifier: String = "",extend_namespace: String = "",extend_exp: bool = false,password: String = "",redirect_uri: String = "",refresh_token: String = "",scope: String = "",username: String = "",auth_trust_id: String = "",device_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	# Basic Auth: use form client_id if provided, otherwise global settings
	if not client_id.is_empty():
		var client_secret_val: String = client_secret
...
func verify_token_v3(token: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func platform_authentication_v3(platform_id: String,state: String,code: String = "",error: String = "",openid_assoc_handle: String = "",openid_claimed_id: String = "",openid_identity: String = "",openid_mode: String = "",openid_ns: String = "",openid_op_endpoint: String = "",openid_response_nonce: String = "",openid_return_to: String = "",openid_sig: String = "",openid_signed: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func platform_token_refresh_v3(platform_token: String,platform_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_get_input_validations(default_on_empty: bool = false,language_code: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_get_input_validation_by_field(field: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_country_age_restriction_v3(country_code: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_config_value_v3(config_key: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_country_list_v3(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## Public Get Input Validations
## GET /iam/v3/public/namespaces/{namespace}/inputValidations
func public_get_namespace_scoped_input_validations(namespace_param: String,default_on_empty: bool = false,language_code: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()

	# Build URL path
	var url_path: String = "/iam/v3/public/namespaces/{namespace}/inputValidations"
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
## Public Get Input Validation by field
## GET /iam/v3/public/namespaces/{namespace}/inputValidations/{field}
func public_get_namespace_scoped_input_validation_by_field(field: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()

	# Build URL path
	var url_path: String = "/iam/v3/public/namespaces/{namespace}/inputValidations/{field}"
	url_path = url_path.replace("{" + "field" + "}", _url_encode(field))
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
...
func retrieve_all_active_third_party_login_platform_credential_public_v3(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func retrieve_active_oidcclients_public_v3(namespace_param: String,client_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_list_user_idby_platform_user_ids_v3(namespace_param: String,platform_id: String,raw_pid: bool = false,raw_puid: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_get_user_by_platform_user_idv3(namespace_param: String,platform_id: String,platform_user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_profile_update_strategy_v3(namespace_param: String,field: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_async_status(namespace_param: String,request_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_search_user_v3(namespace_param: String,by: String = "",limit: int = 0,offset: int = 0,platform_by: String = "",platform_id: String = "",query: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_create_user_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func check_user_availability(namespace_param: String,field: String,query: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_bulk_get_users(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_send_registration_code(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_verify_registration_code(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_forgot_password_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_validate_user_input(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_admin_invitation_v3(invitation_id: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "invitationId" + "}", _url_encode(invitation_id))
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func create_user_from_invitation_v3(invitation_id: String,namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_partial_update_user_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_user_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_send_verification_code_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_user_verification_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_upgrade_headless_account_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_verify_headless_account_v3(namespace_param: String,need_verification_code: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_update_password_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_create_justice_user(namespace_param: String,target_namespace: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_platform_unlink_v3(namespace_param: String,platform_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_platform_link_v3(ticket: String,namespace_param: String,platform_id: String,redirect_uri: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_platform_unlink_all_v3(namespace_param: String,platform_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_force_platform_link_v3(ticket: String,namespace_param: String,platform_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_web_link_platform(namespace_param: String,platform_id: String,client_id: String = "",redirect_uri: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_web_link_platform_establish(namespace_param: String,platform_id: String,state: String,code: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_process_web_link_platform_v3(state: String,namespace_param: String,platform_id: String,code: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_users_platform_infos_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func reset_password_v3(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_get_user_by_user_id_v3(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_user_ban_history_v3(namespace_param: String,user_id: String,active_only: bool = false,limit: int = 0,offset: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_list_user_all_platform_accounts_distinct_v3(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_user_information_v3(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_user_login_histories_v3(namespace_param: String,user_id: String,after: float = 0.0,before: float = 0.0,limit: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_user_platform_accounts_v3(namespace_param: String,user_id: String,after: String = "",before: String = "",limit: int = 0,platform_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_list_justice_platform_accounts_v3(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_link_platform_account(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_force_link_platform_with_progression(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_publisher_user_v3(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_validate_user_by_user_idand_password_v3(password: String,namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_roles_v3(after: String = "",before: String = "",is_wildcard: bool = false,limit: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_role_v3(role_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_my_user_v3(include_all_platforms: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_link_headless_account_to_my_account_conflict_v3(one_time_link_code: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_my_redirection_after_link_v3(one_time_link_code: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_verify_user_by_link_v3(code: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func platform_authenticate_samlv3_handler(platform_id: String,state: String,code: String = "",error: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func login_ssoclient(platform_id: String,payload: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func logout_ssoclient(platform_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func request_target_token_response_v3(code: String,additional_data: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func upgrade_and_authenticate_forward_v3(client_id: String,upgrade_success_token: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_list_invitation_histories_v4(limit: int = 0,namespace_param: String = "",offset: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_devices_by_user_v4(namespace_param: String,user_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_banned_devices_v4(namespace_param: String,device_type: String = "",end_date: String = "",limit: int = 0,offset: int = 0,start_date: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_user_device_bans_v4(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_ban_device_v4(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_device_ban_v4(ban_id: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_device_ban_v4(ban_id: String,namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_generate_report_v4(namespace_param: String,device_type: String,end_date: String = "",start_date: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_device_types_v4(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_device_bans_v4(device_id: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "deviceId" + "}", _url_encode(device_id))
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
## @deprecated
func admin_decrypt_device_v4(device_id: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_unban_device_v4(device_id: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_users_by_device_v4(device_id: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_namespace_invitation_history_v4(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_namespace_user_invitation_history_v4(namespace_param: String,limit: int = 0,offset: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_create_test_users_v4(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_create_user_v4(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_bulk_update_user_account_type_v4(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_bulk_check_valid_user_idv4(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_user_v4(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_user_email_address_v4(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_disable_user_mfav4(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_user_mfastatus_v4(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_remove_user_role_v4(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_list_user_roles_v4(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_add_user_role_v4(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_user_role_v4(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_roles_v4(admin_role: bool = false,is_wildcard: bool = false,limit: int = 0,offset: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_delete_role_v4(role_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_role_v4(role_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_role_v4(role_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_delete_role_permissions_v4(role_id: String,
		body: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_add_role_permissions_v4(role_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_update_role_permissions_v4(role_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_revoke_user_from_role_v4(role_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_list_assigned_users_v4(role_id: String,after: String = "",before: String = "",limit: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_assign_user_to_role_v4(role_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_enable_my_authenticator_v4(code: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_backup_codes_v4(language_tag: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_generate_backup_codes_v4(language_tag: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_enable_backup_codes_v4(language_tag: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_challenge_my_mfav4(code: String = "",factor: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_send_my_mfaemail_code_v4(action: String = "",language_tag: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_enable_my_email_v4(code: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_make_factor_my_default_v4(factor: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_my_own_mfastatus_v4() -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func admin_get_my_mfastatus_v4() -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func authentication_with_platform_link_v4(client_id: String,linking_token: String,password: String,username: String,extend_exp: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func generate_token_by_new_headless_account_v4(linking_token: String,additional_data: String = "",extend_exp: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func verify2_facode_v4(code: String,factor: String,mfa_token: String,remember_device: bool
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func platform_token_grant_v4(platform_id: String,additional_data: String = "",client_id: String = "",create_headless: bool = false,device_id: String = "",mac_address: String = "",platform_token: String = "",service_label: float = 0.0,skip_set_cookie: bool = false,code_challenge: String = "",code_challenge_method: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func simultaneous_login_v4(native_platform: String,native_platform_ticket: String,simultaneous_platform: String = "",simultaneous_ticket: String = "",code_challenge: String = "",code_challenge_method: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func token_grant_v4(grant_type: String,additional_data: String = "",client_id: String = "",client_secret: String = "",code: String = "",code_verifier: String = "",extend_namespace: String = "",extend_exp: bool = false,login_queue_ticket: String = "",password: String = "",redirect_uri: String = "",refresh_token: String = "",scope: String = "",username: String = "",auth_trust_id: String = "",device_id: String = "",code_challenge: String = "",code_challenge_method: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func request_target_token_response_v4(code: String,additional_data: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_list_user_idby_platform_user_ids_v4(namespace_param: String,platform_id: String,raw_puid: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_user_by_platform_user_idv4(namespace_param: String,platform_id: String,platform_user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_create_test_user_v4(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_create_user_v4(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func create_user_from_invitation_v4(invitation_id: String,namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_update_user_v4(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_update_user_email_address_v4(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_upgrade_headless_account_with_verification_code_v4(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_upgrade_headless_account_v4(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_disable_my_authenticator_v4(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_enable_my_authenticator_v4(code: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_generate_my_authenticator_key_v4(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_get_my_backup_codes_v4(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_generate_my_backup_codes_v4(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_disable_my_backup_codes_v4(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_download_my_backup_codes_v4(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_enable_my_backup_codes_v4(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_backup_codes_v4(namespace_param: String,language_tag: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_generate_backup_codes_v4(namespace_param: String,language_tag: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_enable_backup_codes_v4(namespace_param: String,language_tag: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_challenge_my_mfav4(namespace_param: String,code: String = "",factor: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_remove_trusted_device_v4(namespace_param: String,cookie: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_send_my_mfaemail_code_v4(namespace_param: String,action: String = "",language_tag: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_disable_my_email_v4(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_enable_my_email_v4(code: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_my_enabled_factors_v4(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_make_factor_my_default_v4(factor: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_my_own_mfastatus_v4(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_get_my_mfastatus_v4(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_user_public_info_by_user_id_v4(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
