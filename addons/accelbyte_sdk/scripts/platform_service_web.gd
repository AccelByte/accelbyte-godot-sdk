...
##
## Usage:
##   var service = PlatformServiceWeb.new()
##   service.initialize(sdk)  # Pass your AccelByteSDK instance
##   var result = await service.method_name(params)
## =============================================================================

class_name PlatformServiceWeb
extends RefCounted
...
func _http_request(url: String, method: int, headers: PackedStringArray, body: String = "") -> Dictionary:
	print("  [PlatformServiceWeb] %s %s" % [_method_to_string(method), url])
	...
	print("  [PlatformServiceWeb] Response: %d - %s" % [response_code, "success" if result["success"] else "failed"])
	return result
...
func delete_fulfillment_script(id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_fulfillment_script(id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_fulfillment_script(id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func create_fulfillment_script(id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func search_item_type_config(item_type: String,clazz: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_item_type_config(id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_item_type_config(id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_item_type_config(id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_campaigns(namespace_param: String,limit: int = 0,name_param: String = "",offset: int = 0,tag: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func create_campaign(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_campaign(campaign_id: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "campaignId" + "}", _url_encode(campaign_id))
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func update_campaign(campaign_id: String,namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func rename_batch(campaign_id: String,namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_campaign_batch_names(campaign_id: String,namespace_param: String,batch_name: String = "",limit: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_campaign_dynamic(campaign_id: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_catalog_config(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_catalog_config(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_loot_box_plugin_config(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_loot_box_plugin_config(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_loot_box_plugin_config(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func uplod_loot_box_plugin_config_cert(namespace_param: String,file: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_loot_box_grpc_info(namespace_param: String,force: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_section_plugin_config(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_section_plugin_config(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_section_plugin_config(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func upload_section_plugin_config_cert(namespace_param: String,file: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_root_categories(namespace_param: String,store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func create_category(namespace_param: String,store_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func list_categories_basic(namespace_param: String,store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_category(category_path: String,namespace_param: String,store_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "categoryPath" + "}", _url_encode(category_path))
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func get_category(category_path: String,namespace_param: String,store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_category(category_path: String,namespace_param: String,store_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_child_categories(category_path: String,namespace_param: String,store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_descendant_categories(category_path: String,namespace_param: String,store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_codes(campaign_id: String,namespace_param: String,active_only: bool = false,batch_name: String = "",batch_no: Array = [],code: String = "",limit: int = 0,offset: int = 0,with_batch_name: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func create_codes(campaign_id: String,namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func download(campaign_id: String,namespace_param: String,batch_name: String = "",batch_no: Array = [],with_batch_name: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func bulk_disable_codes(campaign_id: String,namespace_param: String,batch_name: String = "",batch_no: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func bulk_enable_codes(campaign_id: String,namespace_param: String,batch_name: String = "",batch_no: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_redeem_history(campaign_id: String,namespace_param: String,code: String = "",limit: int = 0,offset: int = 0,user_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_code(code: String,namespace_param: String,redeemable: bool = false,with_batch_name: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func disable_code(code: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func enable_code(code: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func delete_service_plugin_config(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_service_plugin_config(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func update_service_plugin_config(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func list_currencies(namespace_param: String,currency_type: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func create_currency(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_currency(currency_code: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "currencyCode" + "}", _url_encode(currency_code))
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func update_currency(currency_code: String,namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_currency_config(currency_code: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_currency_summary(currency_code: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_dlcitem_config_history(namespace_param: String,dlc_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func restore_dlcitem_config_history(id: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_dlcitem_config(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_dlcitem_config(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_dlcitem_config(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_platform_dlcconfig(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_platform_dlcconfig(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_platform_dlcconfig(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_entitlements(namespace_param: String,active_only: bool = false,app_type: String = "",entitlement_clazz: String = "",entitlement_name: String = "",item_id: Array = [],limit: int = 0,offset: int = 0,origin: String = "",user_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_entitlements_by_item_ids(namespace_param: String,active_only: bool = false,item_ids: Array = [],limit: int = 0,offset: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func enable_entitlement_origin_feature(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_entitlement_config_info(namespace_param: String,without_cache: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func grant_entitlements(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func revoke_entitlements(namespace_param: String,
		body: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_entitlement(entitlement_id: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "entitlementId" + "}", _url_encode(entitlement_id))
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func query_fulfillment_histories(namespace_param: String,limit: int = 0,offset: int = 0,status: String = "",user_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_iapclawback_history(namespace_param: String,end_time: String = "",event_type: String = "",external_order_id: String = "",limit: int = 0,offset: int = 0,start_time: String = "",status: String = "",user_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func mock_play_station_stream_event(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func mock_xbl_clawback_event(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_apple_iapconfig(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_apple_iapconfig(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_apple_iapconfig(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_apple_p8_file(namespace_param: String,file: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_epic_games_iapconfig(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_epic_games_iapconfig(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_epic_games_iapconfig(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_google_iapconfig(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_google_iapconfig(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_google_iapconfig(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_google_p12_file(namespace_param: String,file: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_iapitem_config(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_iapitem_config(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_iapitem_config(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_oculus_iapconfig(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_oculus_iapconfig(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_oculus_iapconfig(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func list_oculus_subscription_groups(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func create_oculus_subscription_group(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_oculus_subscription_group(namespace_param: String,sku: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	url_path = url_path.replace("{" + "sku" + "}", _url_encode(sku))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func list_oculus_subscription_group_tier(namespace_param: String,sku: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func add_tier_into_meta_quest_subscription_group(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_oculus_subscription_tier(namespace_param: String,sku: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_playstation_iapconfig(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_play_station_iapconfig(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_playstation_iapconfig(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func validate_existed_playstation_iapconfig(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func validate_playstation_iapconfig(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_steam_iapconfig(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_steam_iapconfig(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_steam_iapconfig(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_twitch_iapconfig(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_twitch_iapconfig(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_twitch_iapconfig(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_xbl_apconfig(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_xbl_iapconfig(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_xbl_iapconfig(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_xbl_bpcert_file(namespace_param: String,file: String = "",password: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_third_party_notifications(namespace_param: String,end_date: String = "",external_id: String = "",limit: int = 0,offset: int = 0,source: String = "",start_date: String = "",status: String = "",type_param: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_abnormal_transactions(namespace_param: String,limit: int = 0,offset: int = 0,order_id: String = "",steam_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_steam_job_info(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_reset_steam_job_time(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_refund_iaporder(iap_order_no: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "iapOrderNo" + "}", _url_encode(iap_order_no))
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func query_steam_report_histories(namespace_param: String,limit: int = 0,offset: int = 0,order_id: String = "",process_status: String = "",steam_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_third_party_subscription(namespace_param: String,active_only: bool = false,group_id: String = "",limit: int = 0,offset: int = 0,platform: String = "",product_id: String = "",user_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_iaporder_consume_details(iap_order_no: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func download_invoice_details(namespace_param: String,end_time: String,feature: String,item_id: String,item_type: String,start_time: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func generate_invoice_summary(namespace_param: String,end_time: String,feature: String,item_id: String,item_type: String,start_time: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func create_item(namespace_param: String,store_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func sync_in_game_item(namespace_param: String,store_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_item_by_app_id(namespace_param: String,app_id: String,active_only: bool = false,store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_items(namespace_param: String,active_only: bool = false,app_type: String = "",available_date: String = "",base_app_id: String = "",category_path: String = "",features: String = "",include_sub_category_item: bool = false,item_type: String = "",limit: int = 0,offset: int = 0,region: String = "",sort_by: Array = [],store_id: String = "",tags: String = "",target_namespace: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func list_basic_items_by_features(namespace_param: String,active_only: bool = false,features: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_items(namespace_param: String,item_ids: String,active_only: bool = false,store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_item_by_sku(namespace_param: String,sku: String,active_only: bool = false,store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_locale_item_by_sku(namespace_param: String,sku: String,active_only: bool = false,language: String = "",populate_bundle: bool = false,region: String = "",store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_estimated_price(namespace_param: String,item_ids: String,user_id: String,platform: String = "",region: String = "",store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_item_id_by_sku(namespace_param: String,sku: String,active_only: bool = false,store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_bulk_item_id_by_skus(namespace_param: String,sku: Array = [],store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func bulk_get_locale_items(namespace_param: String,item_ids: String,active_only: bool = false,language: String = "",region: String = "",store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_available_predicate_types(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func validate_item_purchase_condition(namespace_param: String,user_id: String,platform: String = "",
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func bulk_update_region_data(namespace_param: String,store_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func search_items(namespace_param: String,keyword: String,language: String,active_only: bool = false,item_type: String = "",limit: int = 0,offset: int = 0,sort_by: String = "",store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_uncategorized_items(namespace_param: String,active_only: bool = false,limit: int = 0,offset: int = 0,sort_by: Array = [],store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_item(item_id: String,namespace_param: String,features_to_check: Array = [],force: bool = false,store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "itemId" + "}", _url_encode(item_id))
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func get_item(item_id: String,namespace_param: String,active_only: bool = false,store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_item(item_id: String,namespace_param: String,store_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func acquire_item(item_id: String,namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_app(item_id: String,namespace_param: String,active_only: bool = false,store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_app(item_id: String,namespace_param: String,store_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func disable_item(item_id: String,namespace_param: String,store_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_item_dynamic_data(item_id: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func enable_item(item_id: String,namespace_param: String,store_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func defeature_item(feature: String,item_id: String,namespace_param: String,store_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "feature" + "}", _url_encode(feature))
	url_path = url_path.replace("{" + "itemId" + "}", _url_encode(item_id))
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
...
func feature_item(feature: String,item_id: String,namespace_param: String,store_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_locale_item(item_id: String,namespace_param: String,active_only: bool = false,language: String = "",populate_bundle: bool = false,region: String = "",store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_item_purchase_condition(item_id: String,namespace_param: String,store_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_item_references(item_id: String,namespace_param: String,features_to_check: Array = [],store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func return_item(item_id: String,namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_key_groups(namespace_param: String,limit: int = 0,name_param: String = "",offset: int = 0,tag: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func create_key_group(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_key_group_by_booth_name(namespace_param: String,booth_name: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_key_group(key_group_id: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "keyGroupId" + "}", _url_encode(key_group_id))
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func update_key_group(key_group_id: String,namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_key_group_dynamic(key_group_id: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func list_keys(key_group_id: String,namespace_param: String,limit: int = 0,offset: int = 0,status: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func upload_keys(key_group_id: String,namespace_param: String,file: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_orders(namespace_param: String,end_time: String = "",limit: int = 0,offset: int = 0,order_nos: Array = [],sort_by: String = "",start_time: String = "",status: String = "",with_total: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_order_statistics(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_order(namespace_param: String,order_no: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	url_path = url_path.replace("{" + "orderNo" + "}", _url_encode(order_no))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func refund_order(namespace_param: String,order_no: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_payment_callback_config(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func update_payment_callback_config(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_payment_merchant_config(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_payment_domain_whitelist_config(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_payment_notifications(namespace_param: String,end_date: String = "",external_id: String = "",limit: int = 0,notification_source: String = "",notification_type: String = "",offset: int = 0,payment_order_no: String = "",start_date: String = "",status: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_payment_orders(namespace_param: String,channel: String = "",ext_tx_id: String = "",limit: int = 0,offset: int = 0,status: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func create_payment_order_by_dedicated(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func list_ext_order_no_by_ext_tx_id(namespace_param: String,ext_tx_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_payment_order(namespace_param: String,payment_order_no: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	url_path = url_path.replace("{" + "paymentOrderNo" + "}", _url_encode(payment_order_no))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func charge_payment_order(namespace_param: String,payment_order_no: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func refund_payment_order_by_dedicated(namespace_param: String,payment_order_no: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func simulate_payment_order_notification(namespace_param: String,payment_order_no: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_payment_order_charge_status(namespace_param: String,payment_order_no: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_psn_entitlement_ownership(entitlement_label: String,namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "entitlementLabel" + "}", _url_encode(entitlement_label))
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func get_xbox_entitlement_ownership(namespace_param: String,product_sku: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	url_path = url_path.replace("{" + "productSku" + "}", _url_encode(product_sku))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func get_platform_entitlement_config(namespace_param: String,platform: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_platform_entitlement_config(namespace_param: String,platform: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_platform_wallet_config(namespace_param: String,platform: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_platform_wallet_config(namespace_param: String,platform: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func reset_platform_wallet_config(namespace_param: String,platform: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_revocation_config(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_revocation_config(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_revocation_config(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_revocation_histories(namespace_param: String,end_time: String = "",limit: int = 0,offset: int = 0,source: String = "",start_time: String = "",status: String = "",transaction_id: String = "",user_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_revocation_plugin_config(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_revocation_plugin_config(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_revocation_plugin_config(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func upload_revocation_plugin_config_cert_v2(namespace_param: String,file: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func upload_revocation_plugin_config_cert(namespace_param: String,file: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func create_reward(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_rewards(namespace_param: String,event_topic: String = "",limit: int = 0,offset: int = 0,sort_by: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func export_rewards(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func import_rewards(namespace_param: String,replace_existing: bool,file: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_reward(namespace_param: String,reward_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	url_path = url_path.replace("{" + "rewardId" + "}", _url_encode(reward_id))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func get_reward(namespace_param: String,reward_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_reward(namespace_param: String,reward_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func check_event_condition(namespace_param: String,reward_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_reward_condition_record(namespace_param: String,reward_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_sections(namespace_param: String,end: String = "",limit: int = 0,offset: int = 0,start: String = "",store_id: String = "",view_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func create_section(namespace_param: String,store_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func purge_expired_section(namespace_param: String,store_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_section(namespace_param: String,section_id: String,store_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	url_path = url_path.replace("{" + "sectionId" + "}", _url_encode(section_id))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func get_section(namespace_param: String,section_id: String,store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_section(namespace_param: String,section_id: String,store_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func list_stores(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func create_store(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_catalog_definition(namespace_param: String,catalog_type: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func download_csvtemplates(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func export_store_by_csv(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func import_store(namespace_param: String,file: String = "",store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_published_store(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_published_store(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_published_store_backup(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func rollback_published_store(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_store(namespace_param: String,store_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	url_path = url_path.replace("{" + "storeId" + "}", _url_encode(store_id))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func get_store(namespace_param: String,store_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_store(namespace_param: String,store_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_changes(namespace_param: String,store_id: String,action: String = "",item_sku: String = "",item_type: String = "",limit: int = 0,offset: int = 0,selected: bool = false,sort_by: Array = [],status: String = "",type_param: String = "",updated_at_end: String = "",updated_at_start: String = "",with_total: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func publish_all(namespace_param: String,store_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func publish_selected(namespace_param: String,store_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func select_all_records(namespace_param: String,store_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func select_all_records_by_criteria(namespace_param: String,store_id: String,action: String = "",item_sku: String = "",item_type: String = "",selected: bool = false,type_param: String = "",updated_at_end: String = "",updated_at_start: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_statistic(namespace_param: String,store_id: String,action: String = "",item_sku: String = "",item_type: String = "",type_param: String = "",updated_at_end: String = "",updated_at_start: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func unselect_all_records(namespace_param: String,store_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func select_record(change_id: String,namespace_param: String,store_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "changeId" + "}", _url_encode(change_id))
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	url_path = url_path.replace("{" + "storeId" + "}", _url_encode(store_id))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
...
func unselect_record(change_id: String,namespace_param: String,store_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func clone_store(namespace_param: String,store_id: String,target_store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func export_store(namespace_param: String,store_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_import_history(namespace_param: String,store_id: String,end: String = "",limit: int = 0,offset: int = 0,sort_by: String = "",start: String = "",success: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func import_store_by_csv(namespace_param: String,store_id: String,category: String = "",display: String = "",item: String = "",notes: String = "",section: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_subscriptions(namespace_param: String,charge_status: String = "",item_id: String = "",limit: int = 0,offset: int = 0,sku: String = "",status: String = "",subscribed_by: String = "",user_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func recurring_charge_subscription(namespace_param: String,subscription_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_ticket_dynamic(booth_name: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "boothName" + "}", _url_encode(booth_name))
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func decrease_ticket_sale(booth_name: String,namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_ticket_booth_id(booth_name: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func increase_ticket_sale(booth_name: String,namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func commit(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_trade_history_by_criteria(namespace_param: String,limit: int = 0,offset: int = 0,status: String = "",type_param: String = "",user_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_trade_history_by_transaction_id(namespace_param: String,transaction_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	url_path = url_path.replace("{" + "transactionId" + "}", _url_encode(transaction_id))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func unlock_steam_user_achievement(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_xbl_user_achievements(namespace_param: String,user_id: String,xbox_user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_xbl_user_achievement(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func anonymize_campaign(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func anonymize_entitlement(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func anonymize_fulfillment(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func anonymize_integration(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func anonymize_order(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func anonymize_payment(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func anonymize_revocation(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func anonymize_subscription(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func anonymize_wallet(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_user_dlcby_platform(namespace_param: String,user_id: String,type_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_user_dlc(namespace_param: String,user_id: String,include_all_namespaces: bool = false,status: String = "",type_param: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_user_entitlements(namespace_param: String,user_id: String,active_only: bool = false,app_type: String = "",collection_id: String = "",entitlement_clazz: String = "",entitlement_name: String = "",features: Array = [],fuzzy_match_name: bool = false,ignore_active_date: bool = false,item_id: Array = [],limit: int = 0,offset: int = 0,origin: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func grant_user_entitlement(namespace_param: String,user_id: String,
		body: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_user_app_entitlement_by_app_id(namespace_param: String,user_id: String,app_id: String,active_only: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_user_entitlements_by_app_type(namespace_param: String,user_id: String,app_type: String,active_only: bool = false,limit: int = 0,offset: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_user_entitlements_by_ids(namespace_param: String,user_id: String,ids: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_user_entitlement_by_item_id(namespace_param: String,user_id: String,item_id: String,active_only: bool = false,entitlement_clazz: String = "",platform: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_user_active_entitlements_by_item_ids(namespace_param: String,user_id: String,ids: Array = [],platform: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_user_entitlement_by_sku(namespace_param: String,user_id: String,sku: String,active_only: bool = false,entitlement_clazz: String = "",platform: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func exists_any_user_active_entitlement(namespace_param: String,user_id: String,app_ids: Array = [],item_ids: Array = [],platform: String = "",skus: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func exists_any_user_active_entitlement_by_item_ids(namespace_param: String,user_id: String,item_ids: Array,platform: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_user_app_entitlement_ownership_by_app_id(namespace_param: String,user_id: String,app_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_user_entitlement_ownership_by_item_id(namespace_param: String,user_id: String,item_id: String,entitlement_clazz: String = "",platform: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_user_entitlement_ownership_by_item_ids(namespace_param: String,user_id: String,ids: Array = [],platform: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_user_entitlement_ownership_by_sku(namespace_param: String,user_id: String,sku: String,entitlement_clazz: String = "",platform: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func revoke_all_entitlements(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func revoke_user_entitlements(namespace_param: String,user_id: String,entitlement_ids: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_user_entitlement(entitlement_id: String,namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_user_entitlement(entitlement_id: String,namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func consume_user_entitlement(entitlement_id: String,namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func disable_user_entitlement(entitlement_id: String,namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func enable_user_entitlement(entitlement_id: String,namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_user_entitlement_histories(entitlement_id: String,namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func revoke_user_entitlement(entitlement_id: String,namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func revoke_user_entitlement_by_use_count(entitlement_id: String,namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func pre_check_revoke_user_entitlement_by_use_count(entitlement_id: String,namespace_param: String,user_id: String,quantity: int
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func revoke_use_count(entitlement_id: String,namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func sell_user_entitlement(entitlement_id: String,namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func fulfill_item(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func redeem_code(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func pre_check_fulfill_item(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func fulfill_rewards(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_user_iaporders(namespace_param: String,user_id: String,end_time: String = "",limit: int = 0,offset: int = 0,product_id: String = "",start_time: String = "",status: String = "",type_param: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_all_user_iaporders(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_user_iapconsume_history(namespace_param: String,user_id: String,end_time: String = "",limit: int = 0,offset: int = 0,start_time: String = "",status: String = "",type_param: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func mock_fulfill_iapitem(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_sync_oculus_subscriptions(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_get_iaporder_line_items(iap_order_no: String,namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_sync_steam_abnormal_transaction(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_sync_steam_iapby_transaction(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_user_third_party_subscription(namespace_param: String,user_id: String,active_only: bool = false,group_id: String = "",limit: int = 0,offset: int = 0,platform: String = "",product_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_third_party_platform_subscription_ownership_by_group_id(namespace_param: String,platform: String,user_id: String,group_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_third_party_platform_subscription_ownership_by_product_id(namespace_param: String,platform: String,user_id: String,product_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_user_third_party_subscription_transactions(namespace_param: String,user_id: String,active_only: bool = false,group_id: String = "",limit: int = 0,offset: int = 0,platform: String = "",product_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_third_party_subscription_details(id: String,namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_subscription_history(id: String,namespace_param: String,user_id: String,limit: int = 0,offset: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func sync_subscription_transaction(id: String,namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_third_party_user_subscription_details(id: String,namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func sync_subscription(id: String,namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_user_orders(namespace_param: String,user_id: String,discounted: bool = false,item_id: String = "",limit: int = 0,offset: int = 0,status: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func admin_create_user_order(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func count_of_purchased_item(namespace_param: String,user_id: String,item_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_user_order(namespace_param: String,order_no: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_user_order_status(namespace_param: String,order_no: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func fulfill_user_order(namespace_param: String,order_no: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_user_order_grant(namespace_param: String,order_no: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_user_order_histories(namespace_param: String,order_no: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func process_user_order_notification(namespace_param: String,order_no: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func download_user_order_receipt(namespace_param: String,order_no: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func create_user_payment_order(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func refund_user_payment_order(namespace_param: String,payment_order_no: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_user_platform_account_closure_histories(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func apply_user_redemption(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func do_revocation(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func register_xbl_sessions(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_user_subscriptions(namespace_param: String,user_id: String,charge_status: String = "",item_id: String = "",limit: int = 0,offset: int = 0,sku: String = "",status: String = "",subscribed_by: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_user_subscription_activities(namespace_param: String,user_id: String,exclude_system: bool = false,limit: int = 0,offset: int = 0,subscription_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func platform_subscribe_subscription(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func check_user_subscription_subscribable_by_item_id(namespace_param: String,user_id: String,item_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_user_subscription(namespace_param: String,subscription_id: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_user_subscription(namespace_param: String,subscription_id: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func cancel_subscription(namespace_param: String,subscription_id: String,user_id: String,force: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func grant_days_to_subscription(namespace_param: String,subscription_id: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_user_subscription_billing_histories(namespace_param: String,subscription_id: String,user_id: String,exclude_free: bool = false,limit: int = 0,offset: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func process_user_subscription_notification(namespace_param: String,subscription_id: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func acquire_user_ticket(booth_name: String,namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_user_currency_wallets(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func debit_user_wallet_by_currency_code(currency_code: String,namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func list_user_currency_transactions(currency_code: String,namespace_param: String,user_id: String,limit: int = 0,offset: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func check_balance(currency_code: String,namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func check_wallet(currency_code: String,namespace_param: String,user_id: String,origin: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func credit_user_wallet(currency_code: String,namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func debit_by_wallet_platform(currency_code: String,namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func pay_with_user_wallet(currency_code: String,namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_user_wallet(namespace_param: String,user_id: String,wallet_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	url_path = url_path.replace("{" + "userId" + "}", _url_encode(user_id))
	url_path = url_path.replace("{" + "walletId" + "}", _url_encode(wallet_id))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
## @deprecated
func debit_user_wallet(namespace_param: String,user_id: String,wallet_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func disable_user_wallet(namespace_param: String,user_id: String,wallet_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func enable_user_wallet(namespace_param: String,user_id: String,wallet_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func list_user_wallet_transactions(namespace_param: String,user_id: String,wallet_id: String,limit: int = 0,offset: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func list_views(namespace_param: String,store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func create_view(namespace_param: String,store_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_view(namespace_param: String,view_id: String,store_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	url_path = url_path.replace("{" + "viewId" + "}", _url_encode(view_id))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func get_view(namespace_param: String,view_id: String,store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_view(namespace_param: String,view_id: String,store_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_wallet_config(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_wallet_config(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func query_wallets(namespace_param: String,currency_code: String = "",limit: int = 0,offset: int = 0,origin: String = "",user_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func bulk_credit(namespace_param: String,
		body: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func bulk_debit(namespace_param: String,
		body: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_wallet(namespace_param: String,wallet_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func sync_orders(end: String,start: String,next_evaluated_key: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func test_adyen_config(sandbox: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func test_ali_pay_config(sandbox: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func test_checkout_config(sandbox: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func debug_matched_payment_merchant_config(namespace_param: String = "",region: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func test_neon_pay_config(sandbox: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func test_pay_pal_config(sandbox: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func test_stripe_config(sandbox: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_payment_merchant_config_1(id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_adyen_config(id: String,sandbox: bool = false,validate: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func test_adyen_config_by_id(id: String,sandbox: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_ali_pay_config(id: String,sandbox: bool = false,validate: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func test_ali_pay_config_by_id(id: String,sandbox: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_checkout_config(id: String,sandbox: bool = false,validate: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func test_checkout_config_by_id(id: String,sandbox: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_neon_pay_config(id: String,sandbox: bool = false,validate: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func test_neon_pay_config_by_id(id: String,sandbox: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_pay_pal_config(id: String,sandbox: bool = false,validate: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func test_pay_pal_config_by_id(id: String,sandbox: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_stripe_config(id: String,sandbox: bool = false,validate: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func test_stripe_config_by_id(id: String,sandbox: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_wx_pay_config(id: String,validate: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_wx_pay_config_cert(id: String,file: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func test_wx_pay_config_by_id(id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_xsolla_config(id: String,validate: bool = false,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func test_xsolla_config_by_id(id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_xsolla_uiconfig(id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_payment_provider_config(limit: int = 0,namespace_param: String = "",offset: int = 0,region: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func debug_matched_payment_provider_config(namespace_param: String = "",region: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func delete_payment_provider_config(id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func update_payment_provider_config(id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func sync_payment_orders(end: String,start: String,next_evaluated_key: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_root_categories(namespace_param: String,language: String = "",store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func download_categories(namespace_param: String,language: String = "",store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_category(category_path: String,namespace_param: String,language: String = "",store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_child_categories(category_path: String,namespace_param: String,language: String = "",store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_descendant_categories(category_path: String,namespace_param: String,language: String = "",store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_list_currencies(namespace_param: String,currency_type: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func ge_dlcdurable_reward_short_map(namespace_param: String,dlc_type: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_apple_config_version(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_iapitem_mapping(namespace_param: String,platform: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_item_by_app_id(namespace_param: String,app_id: String,language: String = "",region: String = "",store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_query_items(namespace_param: String,app_type: String = "",auto_calc_estimated_price: bool = false,base_app_id: String = "",category_path: String = "",features: String = "",include_sub_category_item: bool = false,item_type: String = "",language: String = "",limit: int = 0,offset: int = 0,region: String = "",sort_by: Array = [],store_id: String = "",tags: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_item_by_sku(namespace_param: String,sku: String,auto_calc_estimated_price: bool = false,language: String = "",region: String = "",store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_estimated_price(namespace_param: String,item_ids: String,region: String = "",store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_bulk_get_items(namespace_param: String,item_ids: String,auto_calc_estimated_price: bool = false,language: String = "",region: String = "",store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_validate_item_purchase_condition(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_search_items(namespace_param: String,keyword: String,language: String,auto_calc_estimated_price: bool = false,item_type: String = "",limit: int = 0,offset: int = 0,region: String = "",store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_app(item_id: String,namespace_param: String,language: String = "",region: String = "",store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_item_dynamic_data(item_id: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_item(item_id: String,namespace_param: String,auto_calc_estimated_price: bool = false,language: String = "",populate_bundle: bool = false,region: String = "",store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func get_payment_customization(namespace_param: String,payment_provider: String,region: String,sandbox: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_payment_url(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_payment_methods(namespace_param: String,payment_order_no: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_unpaid_payment_order(namespace_param: String,payment_order_no: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func pay(namespace_param: String,payment_order_no: String,payment_provider: String = "",zip_code: String = "",
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_check_payment_order_paid_status(namespace_param: String,payment_order_no: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_payment_public_config(namespace_param: String,payment_provider: String,region: String,sandbox: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_qrcode(namespace_param: String,code: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_normalize_payment_return_url(namespace_param: String,order_no: String,payment_order_no: String,payment_provider: String,return_url: String,payer_id: String = "",foreinginvoice: String = "",invoice_id: String = "",payload: String = "",redirect_result: String = "",result_code: String = "",session_id: String = "",status: String = "",token: String = "",type_param: String = "",user_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_payment_tax_value(namespace_param: String,payment_order_no: String,payment_provider: String,zip_code: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_reward_by_code(namespace_param: String,reward_code: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_rewards_1(namespace_param: String,event_topic: String = "",limit: int = 0,offset: int = 0,sort_by: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func get_reward_1(namespace_param: String,reward_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_list_stores(namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_exists_any_my_active_entitlement(namespace_param: String,app_ids: Array = [],item_ids: Array = [],skus: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_my_app_entitlement_ownership_by_app_id(namespace_param: String,app_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_my_entitlement_ownership_by_item_id(namespace_param: String,item_id: String,entitlement_clazz: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_my_entitlement_ownership_by_sku(namespace_param: String,sku: String,entitlement_clazz: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_entitlement_ownership_token(namespace_param: String,app_ids: Array = [],item_ids: Array = [],skus: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func sync_twitch_drops_entitlement(namespace_param: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_my_wallet(currency_code: String,namespace_param: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func sync_epic_game_dlc(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func sync_oculus_dlc(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_sync_psn_dlc_inventory(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_sync_psn_dlc_inventory_with_multiple_service_labels(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func sync_steam_dlc(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func sync_xbox_dlc(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_query_user_entitlements(namespace_param: String,user_id: String,app_type: String = "",entitlement_clazz: String = "",entitlement_name: String = "",features: Array = [],item_id: Array = [],limit: int = 0,offset: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_user_app_entitlement_by_app_id(namespace_param: String,user_id: String,app_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_query_user_entitlements_by_app_type(namespace_param: String,user_id: String,app_type: String,limit: int = 0,offset: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_user_entitlements_by_ids(namespace_param: String,user_id: String,available_platform_only: bool = false,ids: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_get_user_entitlement_by_item_id(namespace_param: String,user_id: String,item_id: String,entitlement_clazz: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func public_get_user_entitlement_by_sku(namespace_param: String,user_id: String,sku: String,entitlement_clazz: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_user_entitlement_history(namespace_param: String,user_id: String,end_date: String = "",entitlement_clazz: String = "",limit: int = 0,offset: int = 0,start_date: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_exists_any_user_active_entitlement(namespace_param: String,user_id: String,app_ids: Array = [],item_ids: Array = [],skus: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_user_app_entitlement_ownership_by_app_id(namespace_param: String,user_id: String,app_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_user_entitlement_ownership_by_item_id(namespace_param: String,user_id: String,item_id: String,entitlement_clazz: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_user_entitlement_ownership_by_item_ids(namespace_param: String,user_id: String,ids: Array = []
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_user_entitlement_ownership_by_sku(namespace_param: String,user_id: String,sku: String,entitlement_clazz: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_user_entitlement(entitlement_id: String,namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_consume_user_entitlement(entitlement_id: String,namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_sell_user_entitlement(entitlement_id: String,namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_split_user_entitlement(entitlement_id: String,namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_transfer_user_entitlement(entitlement_id: String,namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_redeem_code(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_fulfill_apple_iapitem(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func sync_epic_games_inventory(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_fulfill_google_iapitem(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func sync_oculus_subscriptions(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func sync_oculus_consumable_entitlements(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_reconcile_play_station_store(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_reconcile_play_station_store_with_multiple_service_labels(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func sync_steam_inventory(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func sync_steam_abnormal_transaction(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func sync_steam_iapby_transaction(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_query_user_third_party_subscription(namespace_param: String,platform: String,user_id: String,active_only: bool = false,group_id: String = "",limit: int = 0,offset: int = 0,product_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func sync_twitch_drops_entitlement_1(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func sync_xbox_inventory(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_query_user_orders(namespace_param: String,user_id: String,discounted: bool = false,item_id: String = "",limit: int = 0,offset: int = 0,status: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_create_user_order(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_preview_order_price(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_user_order(namespace_param: String,order_no: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_cancel_user_order(namespace_param: String,order_no: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_user_order_histories(namespace_param: String,order_no: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_download_user_order_receipt(namespace_param: String,order_no: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_payment_accounts(namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_delete_payment_account(id: String,namespace_param: String,type_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
	...
	url_path = url_path.replace("{" + "id" + "}", _url_encode(id))
	url_path = url_path.replace("{" + "namespace" + "}", _url_encode(namespace_param))
	url_path = url_path.replace("{" + "type" + "}", _url_encode(type_param))
	url_path = url_path.replace("{" + "userId" + "}", _url_encode(user_id))
	# Replace namespace
	if url_path.contains("{namespace}") and not _namespace.is_empty():
		url_path = url_path.replace("{namespace}", _url_encode(_namespace))
...
func public_list_active_sections(namespace_param: String,user_id: String,auto_calc_estimated_price: bool = false,language: String = "",region: String = "",store_id: String = "",view_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_query_user_subscriptions(namespace_param: String,user_id: String,charge_status: String = "",item_id: String = "",limit: int = 0,offset: int = 0,sku: String = "",status: String = "",subscribed_by: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_subscribe_subscription(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_check_user_subscription_subscribable_by_item_id(namespace_param: String,user_id: String,item_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_user_subscription(namespace_param: String,subscription_id: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_change_subscription_billing_account(namespace_param: String,subscription_id: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_cancel_subscription(namespace_param: String,subscription_id: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_user_subscription_billing_histories(namespace_param: String,subscription_id: String,user_id: String,exclude_free: bool = false,limit: int = 0,offset: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_list_views(namespace_param: String,user_id: String,language: String = "",store_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_wallet(currency_code: String,namespace_param: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_list_user_wallet_transactions(currency_code: String,namespace_param: String,user_id: String,limit: int = 0,offset: int = 0
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func public_get_my_dlccontent(type_param: String,include_all_namespaces: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_fulfillments(namespace_param: String,end_time: String = "",limit: int = 0,offset: int = 0,start_time: String = "",state: String = "",transaction_id: String = "",user_id: String = ""
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func query_items_v2(namespace_param: String,app_type: String = "",available_date: String = "",base_app_id: String = "",category_path: String = "",features: String = "",include_sub_category_item: bool = false,item_name: String = "",item_status: String = "",item_type: Array = [],limit: int = 0,offset: int = 0,region: String = "",section_exclusive: bool = false,sort_by: Array = [],store_id: String = "",tags: String = "",target_namespace: String = "",with_total: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func import_store_1(namespace_param: String,file: String = "",store_id: String = "",strict_mode: bool = false
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func export_store_1(namespace_param: String,store_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func fulfill_rewards_v2(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func fulfill_items(namespace_param: String,transaction_id: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func retry_fulfill_items(namespace_param: String,transaction_id: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
## @deprecated
func revoke_items(namespace_param: String,transaction_id: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func v2_public_fulfill_apple_iapitem(namespace_param: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func fulfill_items_v3(namespace_param: String,transaction_id: String,user_id: String,
		body: Dictionary = {}
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func retry_fulfill_items_v3(namespace_param: String,transaction_id: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
...
func revoke_items_v3(namespace_param: String,transaction_id: String,user_id: String
) -> Dictionary:
	# Update auth token from SDK
	update_auth_token()
